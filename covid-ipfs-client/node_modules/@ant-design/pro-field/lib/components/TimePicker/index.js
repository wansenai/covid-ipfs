...
var FieldTimePicker = function FieldTimePicker(_ref, ref) {
  ...
  if (mode === 'read') {
    var dom = /*#__PURE__*/_react.default.createElement("span", {
      ref: ref
    }, text ? (0, _moment.default)(text, isNumberOrMoment ? undefined : finalFormat).format(finalFormat) : '-');
  ...
  if (mode === 'edit' || mode === 'update') {
    ...
    if (light) {
      ...
      }, /*#__PURE__*/_react.default.createElement(_timePicker.default, (0, _extends2.default)({
        value: momentValue,
        format: format,
        ref: ref
      }, fieldProps, {
      ...
      _dom = /*#__PURE__*/_react.default.createElement(_datePicker.default.TimePicker, (0, _extends2.default)({
        ref: ref,
        format: format,
...
var FieldTimeRangePicker = function FieldTimeRangePicker(_ref2) {
  ...
  if (mode === 'edit' || mode === 'update') {
    ...
    var _dom2 = /*#__PURE__*/_react.default.createElement(_timePicker.default.RangePicker, (0, _extends2.default)({
      format: format,
      bordered: plain === undefined ? true : !plain
    }, fieldProps, {
      value: momentValue
