  ...
  if (mode === 'read') {
    ...
    if (render) {
      return render(rest.text, (0, _objectSpread3.default)({
        mode: mode
      }, rest.fieldProps), /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, dom)) || null;
    }

    return /*#__PURE__*/_react.default.createElement(_space.default, null, dom);
  }

  if (mode === 'edit') {
    var _rest$fieldProps;

    var _dom = /*#__PURE__*/_react.default.createElement(_checkbox.default.Group, (0, _extends2.default)({}, rest.fieldProps, {
      className: (0, _classnames.default)((_rest$fieldProps = rest.fieldProps) === null || _rest$fieldProps === void 0 ? void 0 : _rest$fieldProps.className, "".concat(layoutClassName, "-").concat(layout)),
      options: options
    }));
