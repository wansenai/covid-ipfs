  ...
  if (mode === 'edit') {
    ...
    var _dom = /*#__PURE__*/_react.default.createElement(_spin.default, {
      ...
      tagRender: light ? function (item) {
        ...
        if (valuesLength < 2) return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, item.label);
        /**
        ...
        return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, item.label, " ", itemIndex < valuesLength - 1 ? ',' : '');
      } : undefined
    }, fieldProps, {
      bordered: !light,
