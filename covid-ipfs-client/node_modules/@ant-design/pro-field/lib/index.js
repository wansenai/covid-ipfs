...
var defaultRenderTextByObject = function defaultRenderTextByObject(text, valueType, props) {
  ...
  if (valueType.type === 'progress') {
    return /*#__PURE__*/_react.default.createElement(_Progress.default, (0, _extends2.default)({}, props, {
      text: text,
  ...
  if (valueType.type === 'money') {
    return /*#__PURE__*/_react.default.createElement(_Money.default, (0, _extends2.default)({
  ...
  if (valueType.type === 'percent') {
    return /*#__PURE__*/_react.default.createElement(_Percent.default, (0, _extends2.default)({}, props, {
      text: text,
  ...
  if (valueType.type === 'image') {
    return /*#__PURE__*/_react.default.createElement(_Image.default, (0, _extends2.default)({}, props, {
      text: text,
...
var defaultRenderText = function defaultRenderText(dataValue, valueType, props, valueTypeMap) {
  ...
  if (customValueTypeConfig) {
    ...
    if (mode === 'read') {
      ...
      return (_customValueTypeConfi = customValueTypeConfig.render) === null || _customValueTypeConfi === void 0 ? void 0 : _customValueTypeConfi.call(customValueTypeConfig, dataValue, (0, _objectSpread2.default)((0, _objectSpread2.default)({
        ...
        mode: mode || 'read'
      }), /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, dataValue));
    }
    ...
    if (mode === 'update' || mode === 'edit') {
      ...
      return (_customValueTypeConfi2 = customValueTypeConfig.renderFormItem) === null || _customValueTypeConfi2 === void 0 ? void 0 : _customValueTypeConfi2.call(customValueTypeConfig, dataValue, (0, _objectSpread2.default)({
        text: dataValue
      }, props), /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, dataValue));
    }
  }
  ...
  if (valueType === 'money') {
    return /*#__PURE__*/_react.default.createElement(_Money.default, (0, _extends2.default)({}, props, {
      text: dataValue
    }));
  }
  /** 如果是日期的值 */
  ...
  if (valueType === 'date') {
    return /*#__PURE__*/_react.default.createElement(_FieldHOC.default, null, /*#__PURE__*/_react.default.createElement(_DatePicker.default, (0, _extends2.default)({
      text: dataValue,
      format: "YYYY-MM-DD"
    }, props)));
  }
  ...
  if (valueType === 'dateRange') {
    return /*#__PURE__*/_react.default.createElement(_RangePicker.default, (0, _extends2.default)({
      text: dataValue,
      format: "YYYY-MM-DD"
    }, props));
  }
  ...
  if (valueType === 'time') {
    return /*#__PURE__*/_react.default.createElement(_FieldHOC.default, null, /*#__PURE__*/_react.default.createElement(_TimePicker.default, (0, _extends2.default)({
      text: dataValue,
      format: "HH:mm:ss"
    }, props)));
  }
  ...
  if (valueType === 'timeRange') {
    return /*#__PURE__*/_react.default.createElement(_TimePicker.FieldTimeRangePicker, (0, _extends2.default)({
      text: dataValue,
      format: "HH:mm:ss"
    }, props));
  }
  ...
  if (valueType === 'fromNow') {
    return /*#__PURE__*/_react.default.createElement(_FromNow.default, (0, _extends2.default)({
      text: dataValue
    }, props));
  }

  if (valueType === 'index') {
    return /*#__PURE__*/_react.default.createElement(_IndexColumn.default, null, dataValue + 1);
  }
  ...
  if (valueType === 'percent') {
    return /*#__PURE__*/_react.default.createElement(_Percent.default, (0, _extends2.default)({
      text: dataValue
    }, props));
  }
  ...
  if (valueType === 'code') {
    return /*#__PURE__*/_react.default.createElement(_Code.default, (0, _extends2.default)({
      text: dataValue
    }, props));
  }
  ...
  if (valueType === 'digit') {
    return /*#__PURE__*/_react.default.createElement(_Digit.default, (0, _extends2.default)({
      text: dataValue
    }, props));
  }

  if (valueType === 'digitRange') {
    return /*#__PURE__*/_react.default.createElement(_DigitRange.default, (0, _extends2.default)({
      text: dataValue
    }, props));
  }

  if (valueType === 'second') {
    return /*#__PURE__*/_react.default.createElement(_Second.default, (0, _extends2.default)({
      text: dataValue
    }, props));
  }

  if (valueType === 'select' || valueType === 'text' && (props.valueEnum || props.request)) {
    return /*#__PURE__*/_react.default.createElement(_FieldHOC.default, null, /*#__PURE__*/_react.default.createElement(_Select.default, (0, _extends2.default)({
      text: dataValue
    }, props)));
  }
  ...
  if (valueType === 'rate') {
    return /*#__PURE__*/_react.default.createElement(_Rate.default, (0, _extends2.default)({
      text: dataValue
    }, props));
  }

  if (valueType === 'switch') {
    return /*#__PURE__*/_react.default.createElement(_Switch.default, (0, _extends2.default)({
      text: dataValue
    }, props));
  }

  if (valueType === 'option') {
    return /*#__PURE__*/_react.default.createElement(_Options.default, (0, _extends2.default)({
      text: dataValue
    }, props));
  }

  if (valueType === 'password') {
    return /*#__PURE__*/_react.default.createElement(_Password.default, (0, _extends2.default)({
      text: dataValue
    }, props));
  }
  ...
  if (valueType === 'color') {
    return /*#__PURE__*/_react.default.createElement(_ColorPicker.default, (0, _extends2.default)({
      text: dataValue
    }, props));
  }
...
var ProField = function ProField(_ref, ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, defaultRenderText(mode === 'edit' ? (_ref2 = (_fieldProps$value = fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.value) !== null && _fieldProps$value !== void 0 ? _fieldProps$value : text) !== null && _ref2 !== void 0 ? _ref2 : '' : (_ref3 = text !== null && text !== void 0 ? text : fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.value) !== null && _ref3 !== void 0 ? _ref3 : '', valueType || 'text', (0, _objectSpread2.default)((0, _objectSpread2.default)({
    ref: ref
  }, rest), {}, {
