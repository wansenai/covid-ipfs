...
function renderDefaultOption(options, defaultOptions, actions, columns) {
  return Object.keys(options).filter(function (item) {
    ...
    if (key === 'setting') {
      return /*#__PURE__*/_react.default.createElement(_ColumnSetting.default, (0, _extends2.default)({}, options[key], {
        columns: columns,
        key: key
      }));
    }
...
function ToolBar(_ref2) {
  ...
  return /*#__PURE__*/_react.default.createElement(_ListToolBar.default, (0, _extends2.default)({
    title: headerTitle,
