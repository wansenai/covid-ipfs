...
declare function ProFormList<T>({ actionRender, creatorButtonProps, label, alwaysShowItemLabel, tooltip, creatorRecord, itemRender, rules, itemContainerRender, fieldExtraRender, copyIconProps, children, deleteIconProps, actionRef, style, prefixCls, actionGuard, min, max, colProps, rowProps, ...rest }: ProFormListProps<T>): JSX.Element | null;
