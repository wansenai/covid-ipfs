...
var CheckCard = function CheckCard(props) {
  ...
  var renderCover = function renderCover(prefixCls, cover) {
    ...
    }, typeof cover === 'string' ? /*#__PURE__*/_react.default.createElement("img", {
      src: cover,
      alt: "checkcard"
    }) : cover);
  };
  ...
  var metaDom = (0, _react.useMemo)(function () {
    if (cardLoading) {
      return /*#__PURE__*/_react.default.createElement(_Group.CardLoading, {
        prefixCls: prefixCls || ''
      });
    }
    ...
    var avatarDom = avatar ? /*#__PURE__*/_react.default.createElement("div", {
      className: "".concat(prefixCls, "-avatar")
    }, typeof avatar === 'string' ? /*#__PURE__*/_react.default.createElement(_avatar.default, {
      size: 48,
      shape: "square",
      src: avatar
    }) : avatar) : null;

    var headerDom = (title || extra) && /*#__PURE__*/_react.default.createElement("div", {
    ...
    var descriptionDom = description ? /*#__PURE__*/_react.default.createElement("div", {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      className: metaClass
    }, avatarDom, headerDom || descriptionDom ? /*#__PURE__*/_react.default.createElement("div", {
